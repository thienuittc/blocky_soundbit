...
Blockly.Blocks["block_sound_rotary"] = {
  init: function() {
    this.jsonInit({
      type: "block_sound_rotary",
      message0: "đọc vị trí biến trở xoay",
      output: null,
      colour: "#780779",
      tooltip: "",
      helpUrl: ""
...
Blockly.Python["block_sound_rotary"] = function(block) {
  Blockly.Python.definitions_["import_yolobit"] = "from yolobit import *";

  // TODO: Assemble Python into code variable.
  var code = "round((pin16.read_analog()/4 -1)/10.23)";
  // TODO: Change ORDER_NONE to the correct strength.
  return [code, Blockly.Python.ORDER_NONE];
};
